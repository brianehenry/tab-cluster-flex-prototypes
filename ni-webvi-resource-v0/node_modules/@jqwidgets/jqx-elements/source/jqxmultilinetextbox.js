...
JQX('jqx-multiline-text-box', class MultilineTextBox extends JQX.TextBox {
    ...
    */
    _createElement() {
        ...
        that.classList.add('jqx-element-ready');
        that._setFocusable();
    ...
    _keyDownHandler(event) {
        ...
        switch (key) {
            ...
            case 'PageDown': {
                ...
                that.$.input.scrollTop = that._scrollView.scrollHeight;
   ...
   */
    ...
    */
    _mouseWheelHandler(event) {
        ...
        if (that.horizontalScrollBarVisibility === 'auto' || that.horizontalScrollBarVisibility === 'visible') {
            that._scrollView.scrollTo(that._scrollView.scrollTop + (event.deltaY < 0 ? -that.offsetHeight : that.offsetHeight));
        }
    ...
    _documentSelectionOutsideHandler(event) {
        ...
        function scrollElement(horizontally) {
            const elementCoordinates = that.getBoundingClientRect(),
                pointerOffset = horizontally ? elementCoordinates.left - event.pageX : elementCoordinates.top - event.pageY,
