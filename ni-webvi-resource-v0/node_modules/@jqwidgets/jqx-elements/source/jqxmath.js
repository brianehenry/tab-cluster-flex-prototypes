(function (window) {
    ...
    window.BigNumberNG = function (n, p, r) {
        var o = this, i;
        if (n instanceof BigNumberNG) {
        ...
        o.precision = isNaN(p = Math.abs(p)) ? BigNumberNG.defaultPrecision : p;
        o.roundType = isNaN(r = Math.abs(r)) ? BigNumberNG.defaultRoundType : r;
        o._s = (n += '').charAt(0) == '-';
    ...
    var $ = BigNumberNG,
        o = BigNumberNG.prototype;

    $.ROUND_HALF_EVEN = ($.ROUND_HALF_DOWN = ($.ROUND_HALF_UP = ($.ROUND_FLOOR = ($.ROUND_CEIL = ($.ROUND_DOWN = ($.ROUND_UP = 0) + 1) + 1) + 1) + 1) + 1) + 1;
    $.defaultPrecision = 40;
    $.defaultRoundType = $.ROUND_HALF_UP;
    o.add = function (n) {
        if (this.isZero() && this._s) { // this.toString() is '-0'
            this._s = false;
        }

        if (n === 0 || (n.constructor === BigNumberNG && n._d.length === 1 && n._d[0] === 0)) {
            return new BigNumberNG(this);
        }

        if (this._s != (n = new BigNumberNG(n))._s)
            return n._s ^= 1, this.subtract(n);
        var o = new BigNumberNG(this), a = o._d, b = n._d, la = o._f,
            lb = n._f, i, r;
        n = Math.max(la, lb);
    ...
    o.subtract = function (n) {
        ...
        var o = new BigNumberNG(this), c = o.abs().compare(n.abs()) + 1, a = c ? o : n, b = c ? n : o, la = a._f, lb = b._f, d = la, i, j;
    ...
    o.multiply = function (n) {
        var o = new BigNumberNG(this), r = o._d.length >= (n = new BigNumberNG(n))._d.length, a = (r ? o : n)._d,
    b = (r ? n : o)._d, la = a.length, lb = b.length, x = new BigNumberNG, i, j, s;
        for (i = lb; i; r && s.unshift(r), x.set(x.add(new BigNumberNG(s.join('')))))
            for (s = (new Array(lb - --i)).join('0').split(''), r = 0, j = la; j; r += a[--j] * b[i], s.unshift(r % 10), r = (r / 10) >>> 0);
        return o._s = o._s != n._s, o._f = ((r = la + lb - o._f - n._f) >= (j = (o._d = x._d).length) ? this._zeroes(o._d, r - j + 1, 1).length : j) - r, o.round();
    };
    o.divide = function (n) {
        if ((n = new BigNumberNG(n)) == '0')
            throw new Error('Division by 0');
        else if (this == '0')
            return new BigNumberNG;
        var o = new BigNumberNG(this), a = o._d, b = n._d, la = a.length - o._f,
    lb = b.length - n._f, r = new BigNumberNG, i = 0, j, s, l, f = 1, c = 0, e = 0;
        r._s = o._s != n._s, r.precision = Math.max(o.precision, n.precision),
    r._f = +r._d.pop(), la != lb && o._zeroes(la > lb ? b : a, Math.abs(la - lb));
        n._f = b.length, b = n, b._s = false, b = b.round();
        for (n = new BigNumberNG; a[0] == '0'; a.shift());
        out:
            do {
                ...
                var y;
                for (s = new BigNumberNG, j = 0; n.compare(y = s.add(b)) + 1 && ++j; s.set(y));
    ...
    o.pow = function (n) {
        var o = new BigNumberNG(this), i;
        if ((n = (new BigNumberNG(n)).intPart()) == 0) return o.set(1);
        for (i = Math.abs(n); --i; o.set(o.multiply(this)));
        return n < 0 ? o.set((new BigNumberNG(1)).divide(o)) : o;
    };
    o.set = function (n) {
        return this.constructor(n), this;
    };
    o.compare = function (n) {
        var a = this, la = this._f, b = new BigNumberNG(n), lb = b._f, r = [-1, 1], i, l, arr;
    ...
    o.negate = function () {
        var n = new BigNumberNG(this); return n._s ^= 1, n;
    };
    o.abs = function () {
        var n = new BigNumberNG(this); return n._s = 0, n;
    };
    o.intPart = function () {
        return new BigNumberNG((this._s ? '-' : '') + (this._d.slice(0, this._f).join('') || '0'));
    };
    o.valueOf = o.toString = function (radix, wordLength) {
        ...
        function toBinary(positiveNumber) {
            ...
            while (temp.compare(new BigNumberNG(0)) === 1);
    ...
    o.round = function () {
        ...
        var $ = BigNumberNG, r = this.roundType, b = this._d, d, p, n, x;
