...
(function () {
    ...
    var STRETCH_ENUM = Object.freeze({
        NONE: 'none',
        UNIFORM: 'uniform',
    ...
    NationalInstruments.HtmlVI.Elements.NIElement.defineElementInfo(UrlImage.prototype, 'ni-url-image', 'HTMLNIUrlImage');
