...
(function (parent) {
    ...
    proto.bindToView = function () {
        ...
        this.element.addEventListener('value-changed', function (evt) {
            if (evt.target === that.element) {
                var newValue = NUM_VALUE_CONVERTER.convertBack(evt.detail.value, that.model.niType);
    ...
    proto.updateModelFromElement = function () {
        ...
        var element = this.element, model = this.model, nitype = new NIType(element.niType);
        model.niType = nitype;
