...
(function (parent) {
    ...
    var getArrayViewerAndClones = function (rootArrayViewModel, arrayViewer, arrayViewerModel) {
        var arrayViewers = [arrayViewer];
    ...
    proto.modelPropertyChanged = function (propertyName) {
        ...
        switch (propertyName) {
            ...
            case 'defaultElementValue':
                var rootArrayViewModel = findRootArrayViewModel(this.model, this.element.viRef);
                var arrayViewers = getArrayViewerAndClones(rootArrayViewModel, this.element, this.model);
                for (i = 0; i < arrayViewers.length; i++) {
