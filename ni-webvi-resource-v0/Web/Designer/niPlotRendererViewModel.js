...
(function (parent) {
    ...
    proto.registerViewModelProperties(proto, function (targetPrototype, parentMethodName) {
        ...
        proto.addViewModelProperty(targetPrototype, { propertyName: 'barBaseLine' });
    });
    NationalInstruments.HtmlVI.NIModelProvider.registerViewModel(child, NationalInstruments.HtmlVI.Elements.CartesianPlotRenderer, NationalInstruments.HtmlVI.Models.PlotRendererModel, 'ni-cartesian-plot-renderer');
