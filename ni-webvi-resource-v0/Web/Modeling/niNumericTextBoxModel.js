...
(function (parent) {
    ...
    proto.registerModelProperties(proto, function (targetPrototype, parentMethodName) {
        ...
        proto.addModelProperty(targetPrototype, { propertyName: 'spinButtonsPosition', defaultValue: 'right' });
        proto.addModelProperty(targetPrototype, { propertyName: 'textAlignment', defaultValue: 'right' });
    });
