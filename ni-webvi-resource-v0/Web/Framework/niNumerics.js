...
NationalInstruments.HtmlVI.NINumerics.Helpers =
    (function () {
        ...
        var coerceSignificantDigits = function (sigDigits, unsetValue) {
            ...
            var value = new window.JQX.Utilities.BigNumber(valueBig), factor = new window.JQX.Utilities.BigNumber(factorBig), zero = new window.JQX.Utilities.BigNumber('0'), two = new window.JQX.Utilities.BigNumber('2');
